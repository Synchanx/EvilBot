...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`Woii` [👿](https://telegra.ph/file/3a5878e37f56748f40706.jpg) `Nama Gua` *RoomseX Robot*
`Tugas gua rapiin nih grup jadi jangan bandel` *📚𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text="𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐏𝐥𝐚𝐜𝐞😇", url="t.me/ROOMSEXEBOT?startgroup=true"),
    ],
     [
        InlineKeyboardButton(text="𝐀𝐛𝐨𝐮𝐭💝", callback_data="evil_"),
        InlineKeyboardButton(
            text="𝐌𝐲 𝐖𝐞𝐛🌐", url=f"http://t.me/needmq"
        ),
     ],
     [  
        InlineKeyboardButton(text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭🛠", url="https://t.me/needmeq"),
        InlineKeyboardButton(text="𝐑𝐞𝐩𝐨🇮🇳", url="https://t.me/needmeq"),
    ], 
...
HELP_STRINGS = """
`Woyy Gua` 👿 *RoomseX Robot* [👿](https://telegra.ph/file/3a5878e37f56748f40706.jpg)
`udah tekan aja..`"""
evil_IMG = "hhttps://telegra.ph/file/3a5878e37f56748f40706.jpg"
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @needmq \
